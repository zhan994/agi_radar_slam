...
class ParamServer {
 public:
  ...
  ParamServer() {
    ...
    nh.param<std::string>("radar_slam/pointCloudTopic", pointCloudTopic,
                          "/radar_enhanced_pcl");
    ...
    nh.param<std::string>("radar_slam/baselinkFrame", baselinkFrame,
                          "base_link");
    nh.param<std::string>("radar_slam/odometryFrame", odometryFrame,
                          "odom_imu");
    ...
    nh.param<std::string>("radar_slam/savePCDDirectory", savePCDDirectory,
                          "/Downloads/LOAM/");
    ...
    nh.param<vector<double>>("radar_slam/extrinsicRot", extRotV,
                             vector<double>());
    nh.param<vector<double>>("radar_slam/extrinsicRPY", extRPYV,
                             vector<double>());
    nh.param<vector<double>>("radar_slam/extrinsicTrans", extTransV,
                             vector<double>());
    ...
    nh.param<float>("radar_slam/odometrySurfLeafSize", odometrySurfLeafSize,
                    0.2);
    nh.param<float>("radar_slam/mappingCornerLeafSize", mappingCornerLeafSize,
                    0.2);
    ...
    nh.param<double>("radar_slam/mappingProcessInterval",
                     mappingProcessInterval, 0.15);

    nh.param<float>("radar_slam/surroundingkeyframeAddingDistThreshold",
                    surroundingkeyframeAddingDistThreshold, 1.0);
    nh.param<float>("radar_slam/surroundingkeyframeAddingAngleThreshold",
                    surroundingkeyframeAddingAngleThreshold, 0.2);
    nh.param<float>("radar_slam/surroundingKeyframeDensity",
                    surroundingKeyframeDensity, 1.0);
    nh.param<float>("radar_slam/surroundingKeyframeSearchRadius",
                    surroundingKeyframeSearchRadius, 50.0);

    nh.param<bool>("radar_slam/loopClosureEnableFlag", loopClosureEnableFlag,
                   false);
    nh.param<float>("radar_slam/loopClosureFrequency", loopClosureFrequency,
                    1.0);
    nh.param<int>("radar_slam/surroundingKeyframeSize", surroundingKeyframeSize,
                  50);
    nh.param<float>("radar_slam/historyKeyframeSearchRadius",
                    historyKeyframeSearchRadius, 10.0);
    nh.param<float>("radar_slam/historyKeyframeSearchTimeDiff",
                    historyKeyframeSearchTimeDiff, 30.0);
    nh.param<int>("radar_slam/historyKeyframeSearchNum",
                  historyKeyframeSearchNum, 25);
    nh.param<float>("radar_slam/historyKeyframeFitnessScore",
                    historyKeyframeFitnessScore, 0.3);

    nh.param<float>("radar_slam/globalMapVisualizationSearchRadius",
                    globalMapVisualizationSearchRadius, 1e3);
    nh.param<float>("radar_slam/globalMapVisualizationPoseDensity",
                    globalMapVisualizationPoseDensity, 10.0);
    nh.param<float>("radar_slam/globalMapVisualizationLeafSize",
